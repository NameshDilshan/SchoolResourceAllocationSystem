...
namespace ip_prj
{
    public partial class register : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            up.User_name = comboBox3.SelectedItem.ToString();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            rg.User_name = comboBox3.SelectedItem.ToString();
        ...
        private void StuBtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            up.User_name = comboBox4.SelectedItem.ToString();
        ...
        private void StuBtnSave_Click(object sender, EventArgs e)
        {
            ...
            rg.User_name = comboBox4.SelectedItem.ToString();
