...
<div style="text-align: center">
    ...
    <asp:Label ID="Label2" runat="server" Text="aa" Font-Bold="True" Font-Size="XX-Large" ForeColor="#25D366"></asp:Label>
    
          <asp:GridView ID="GridView2" runat="server" Height="150px" Width="100%" style="margin-left: 0px" AutoGenerateColumns="false" BackColor="#66CCFF" BorderColor="Green" BorderStyle="Solid" HorizontalAlign="Center" Font-Bold="True" Font-Size="X-Large" ForeColor="Black">
        ...
        <br />
		   ...
		   <div style="text-align: center">
			  <asp:Button ID="Button1" runat="server" Text="Full Time Table" OnClick="Button1_Click" /></div>
				<br />
			<div>
		<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BackColor="LightYellow" BorderColor="Green" BorderStyle="Solid" BorderWidth="2px" Width="1378px"  HorizontalAlign="Center" ForeColor="Black">
